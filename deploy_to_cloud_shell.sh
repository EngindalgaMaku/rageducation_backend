...
echo "📦 This includes PDF Marker and Sentence Transformers dependencies"
...
curl -s "${SERVICE_URL}/models" | jq . || echo "Models endpoint response received"

echo ""
echo "✅ Deployment successful!"
echo "🌐 Your RAG API is now running at: ${SERVICE_URL}"
echo "📊 PDF Marker and Sentence Transformers are included"
echo "💰 Configured for academic research (scale-to-zero, cost-optimized)"
echo ""
